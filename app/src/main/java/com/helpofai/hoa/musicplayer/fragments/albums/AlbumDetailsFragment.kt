 ...
 *
 */
package com.helpofai.hoa.musicplayer.fragments.albums
...
import com.helpofai.hoa.appthemehelper.common.ATHToolbarActivity.getToolbarBackgroundColor
import com.helpofai.hoa.appthemehelper.util.ToolbarContentTintHelper
import com.helpofai.hoa.musicplayer.EXTRA_ALBUM_ID
import com.helpofai.hoa.musicplayer.EXTRA_ARTIST_ID
import com.helpofai.hoa.musicplayer.EXTRA_ARTIST_NAME
import com.helpofai.hoa.musicplayer.R
import com.helpofai.hoa.musicplayer.activities.tageditor.AbsTagEditorActivity
import com.helpofai.hoa.musicplayer.activities.tageditor.AlbumTagEditorActivity
import com.helpofai.hoa.musicplayer.adapter.album.HorizontalAlbumAdapter
import com.helpofai.hoa.musicplayer.adapter.song.SimpleSongAdapter
import com.helpofai.hoa.musicplayer.ads.AdsManager
import com.helpofai.hoa.musicplayer.databinding.FragmentAlbumDetailsBinding
...
import com.helpofai.hoa.musicplayer.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import com.helpofai.hoa.musicplayer.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import com.helpofai.hoa.musicplayer.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
import com.helpofai.hoa.musicplayer.network.Result
import com.helpofai.hoa.musicplayer.network.model.LastFmAlbum
import com.helpofai.hoa.musicplayer.repository.RealRepository
import com.helpofai.hoa.musicplayer.util.*
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Banner ad at bottom of detail page
        binding.adContainerDetail?.let { container ->
            if (AdsManager.shouldShowAds()) {
                container.isVisible = true
                AdsManager.loadBannerAd(container)
            } else {
