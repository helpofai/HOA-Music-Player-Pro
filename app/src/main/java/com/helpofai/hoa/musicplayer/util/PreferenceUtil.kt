...
object PreferenceUtil {
    ...
    var isSpatialMode: Boolean
        get() = sharedPreferences.getBoolean("audio_spatial_mode", false)
        set(value) = sharedPreferences.edit { putBoolean("audio_spatial_mode", value) }
