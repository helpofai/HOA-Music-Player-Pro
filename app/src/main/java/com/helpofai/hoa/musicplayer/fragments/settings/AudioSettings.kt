...
class AudioSettings : AbsSettingsFragment() {
    ...
    private fun applyAudioSignature(signature: String) {
        ...
        when (signature) {
            "signature" -> { // Balanced Studio Sound
                width = 105
                clarity = 30
                bass = 40
                reverb = 10
            }
            "bass_head" -> { // Heavy Surgical Bass
                width = 100
                clarity = 20
                bass = 75
                reverb = 0
            }
            "vocal_air" -> { // Crisp Vocals & Texture
                width = 115
                clarity = 70
                bass = 20
                reverb = 15
            }
            "live_stadium" -> { // Immersion & 8D Depth
                width = 130
                clarity = 40
                bass = 45
                reverb = 50
            }
            "vinyl_warmth" -> { // Analog Tape Feel
                width = 95
                clarity = 15
                bass = 55
                reverb = 20
            }
            "spatial_8d" -> { // 360-Degree Spherical (spatial removed)
                width = 145
                clarity = 50
                bass = 40
                reverb = 40
