...
import com.helpofai.hoa.musicplayer.service.MusicService.Companion.ACTION_PAUSE
import com.helpofai.hoa.musicplayer.service.MusicService.Companion.ACTION_PLAY
...
import com.helpofai.hoa.musicplayer.service.MusicService.Companion.ACTION_STOP
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "hoaMusicApp:Wakelock headset button"
                )
