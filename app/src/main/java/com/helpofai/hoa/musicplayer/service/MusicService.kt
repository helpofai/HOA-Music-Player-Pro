...
import com.helpofai.hoa.musicplayer.activities.LockScreenActivity
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetBig
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetCard
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetCircle
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetClassic
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetMD3
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetSmall
import com.helpofai.hoa.musicplayer.appwidgets.AppWidgetText
import com.helpofai.hoa.musicplayer.auto.AutoMediaIDHelper
...
import com.helpofai.hoa.musicplayer.providers.MusicPlaybackQueueStore
import com.helpofai.hoa.musicplayer.providers.SongPlayCountStore
import com.helpofai.hoa.musicplayer.service.notification.PlayingNotification
...
import com.helpofai.hoa.musicplayer.util.MusicUtil.toggleFavorite
import com.helpofai.hoa.musicplayer.util.PackageValidator
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.crossFadeDuration
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isAlbumArtOnLockScreen
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isBluetoothSpeaker
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isBlurredAlbumArt
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isHeadsetPlugged
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isLockScreen
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.isPauseOnZeroVolume
...
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import com.helpofai.hoa.musicplayer.volume.AudioVolumeObserver
import com.helpofai.hoa.musicplayer.volume.OnAudioVolumeChangedListener
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    override fun onSharedPreferenceChanged(
        ...
        when (key) {
            ...
            "audio_spatial_mode" -> (playback as? HoaExoPlayer)?.setSpatialMode(com.helpofai.hoa.musicplayer.util.PreferenceUtil.isSpatialMode)
        }
    }
