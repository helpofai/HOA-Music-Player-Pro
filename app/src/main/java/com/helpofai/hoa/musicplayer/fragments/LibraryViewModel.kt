 ...
 *
 */
package com.helpofai.hoa.musicplayer.fragments
...
import com.helpofai.hoa.musicplayer.util.DensityUtil
...
class LibraryViewModel(
    ...
    private suspend fun fetchPlayCountSongs() {
        playCountSongsData.postValue(repository.topPlayedSongs())
    }
    ...
    fun observableHistorySongs(): LiveData<List<Song>> {
        viewModelScope.launch(IO) {
            songHistory.postValue(repository.recentlyPlayedTracks())
        }
        return songHistory
    }
