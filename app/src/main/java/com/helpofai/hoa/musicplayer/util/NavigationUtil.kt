...
import com.helpofai.hoa.musicplayer.activities.DriveModeActivity
import com.helpofai.hoa.musicplayer.activities.LicenseActivity
import com.helpofai.hoa.musicplayer.activities.PrivacyPolicyFragment
import com.helpofai.hoa.musicplayer.activities.SupportDevelopmentActivity
import com.helpofai.hoa.musicplayer.activities.WhatsNewFragment
import com.helpofai.hoa.musicplayer.activities.bugreport.BugReportActivity
import com.helpofai.hoa.musicplayer.extensions.showToast
import com.helpofai.hoa.musicplayer.helper.MusicPlayerRemote.audioSessionId
...
object NavigationUtil {
    ...
    fun goToPrivacyPolicy(activity: FragmentActivity) {
        val fragment = PrivacyPolicyFragment()
        fragment.show(activity.supportFragmentManager, PrivacyPolicyFragment.TAG)
    }
