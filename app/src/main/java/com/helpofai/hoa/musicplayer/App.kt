...
import com.helpofai.hoa.musicplayer.activities.ErrorActivity
import com.helpofai.hoa.musicplayer.activities.MainActivity
import com.helpofai.hoa.musicplayer.appshortcuts.DynamicShortcutManager
import com.helpofai.hoa.musicplayer.ads.AdsManager
import com.helpofai.hoa.musicplayer.billing.BillingManager
import com.helpofai.hoa.musicplayer.helper.WallpaperAccentManager
    ...
    override fun onCreate() {
        ...
        if (!ThemeStore.isConfigured(this, 3)) {
            ThemeStore.editTheme(this)
                .accentColorRes(com.helpofai.hoa.appthemehelper.R.color.md_deep_purple_A200)
        ...
        MobileAds.initialize(this) {
            AdsManager.logDiagnostics()
            // Preload first native ad in background so it's cached when Home loads
            if (AdsManager.shouldShowAds()) {
                AdsManager.preloadNativeAd(this)
            }
        }
    }
