 ...
 *
 */
package com.helpofai.hoa.musicplayer.fragments.player.gradient
...
import com.helpofai.hoa.musicplayer.adapter.song.PlayingQueueAdapter
import com.helpofai.hoa.musicplayer.databinding.FragmentGradientPlayerBinding
import com.helpofai.hoa.musicplayer.extensions.applyColor
...
import com.helpofai.hoa.musicplayer.extensions.getSongInfo
import com.helpofai.hoa.musicplayer.extensions.hide
import com.helpofai.hoa.musicplayer.extensions.ripAlpha
import com.helpofai.hoa.musicplayer.extensions.show
import com.helpofai.hoa.musicplayer.extensions.whichFragment
import com.helpofai.hoa.musicplayer.fragments.MusicSeekSkipTouchListener
...
import com.helpofai.hoa.musicplayer.fragments.other.VolumeFragment
...
class GradientPlayerFragment : AbsPlayerFragment(R.layout.fragment_gradient_player),
    ...
    override fun onUpdateProgressViews(progress: Int, total: Int) {
        val progressSlider = binding.playbackControlsFragment.progressSlider
        val from = progressSlider.valueFrom
        val to = if (total.toFloat() > from) total.toFloat() else from + 1f
        progressSlider.valueTo = to

        progressSlider.value =
            progress.toFloat().coerceIn(from, to)
