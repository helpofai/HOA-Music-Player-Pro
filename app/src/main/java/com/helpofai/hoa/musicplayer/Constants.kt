...
object Constants {
    ...
    const val WEBSITE = "https://hoamusic.app"
    const val GITHUB_PROJECT = "https://github.com/hoaMusicPlayer/hoaMusicPlayer"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/hoamusiclog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_TELEGRAM_LINK = "https://t.me/hoamusicapp/"
    const val APP_TWITTER_LINK = "https://twitter.com/hoamusicapp"
    const val FAQ_LINK = "https://github.com/hoaMusicPlayer/hoaMusicPlayer/blob/master/FAQ.md"
