...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=com.helpofai.hoa.musicplayer"
    const val TRANSLATE = "https://crowdin.com/project/hoamusicplayer"
    const val WEBSITE = "https://helpofai.com"
    const val GITHUB_PROJECT = "https://github.com/helpofai/HOA-Music-Player-Pro"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/hoamusiclog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_TELEGRAM_LINK = "https://t.me/movie_mart_official"
    const val APP_TWITTER_LINK = "https://x.com/HelpOfAi"
    const val FAQ_LINK = "https://github.com/helpofai/HOA-Music-Player-Pro/blob/master/FAQ.md"
    const val PINTEREST = "https://in.pinterest.com/hoamusicapp/"
    const val PRIVACY_POLICY_LINK = "file:///android_asset/privacy_policy.html"
...
const val TOGGLE_AUDIO_OFFLOAD = "toggle_audio_offload"
const val SWIPE_DOWN_DISMISS = "swipe_to_dismiss"
const val ENABLE_SEARCH_PLAYLIST= "enable_search_playlist"
const val NOISE_CANCELLATION = "audio_noise_cancellation"
const val NOISE_CANCELLATION_STRENGTH = "audio_noise_cancellation_strength"