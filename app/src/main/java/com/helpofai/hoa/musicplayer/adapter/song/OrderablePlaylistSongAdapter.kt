...
import com.helpofai.hoa.musicplayer.db.toSongsEntity
import com.helpofai.hoa.musicplayer.dialogs.RemoveSongFromPlaylistDialog
...
class OrderablePlaylistSongAdapter(
    ...
    itemLayoutRes: Int,
) : SongAdapter(activity, dataSet, itemLayoutRes, showAds = false),
