 ...
 *
 */
package com.helpofai.hoa.musicplayer.fragments.folder
...
import com.helpofai.hoa.appthemehelper.ThemeStore.Companion.accentColor
import com.helpofai.hoa.appthemehelper.common.ATHToolbarActivity
import com.helpofai.hoa.appthemehelper.util.ToolbarContentTintHelper
import com.helpofai.hoa.musicplayer.R
import com.helpofai.hoa.musicplayer.adapter.SongFileAdapter
import com.helpofai.hoa.musicplayer.adapter.Storage
import com.helpofai.hoa.musicplayer.adapter.StorageAdapter
import com.helpofai.hoa.musicplayer.adapter.StorageClickListener
import com.helpofai.hoa.musicplayer.databinding.FragmentFolderBinding
...
import com.helpofai.hoa.musicplayer.helper.MusicPlayerRemote.openQueueKeepShuffleMode
import com.helpofai.hoa.musicplayer.helper.ScanMusicBottomSheet
...
import com.helpofai.hoa.musicplayer.interfaces.IMainActivityFragmentCallbacks
import com.helpofai.hoa.musicplayer.interfaces.IScrollHelper
import com.helpofai.hoa.musicplayer.misc.FolderMediaScannerCompletionListener

import com.helpofai.hoa.musicplayer.misc.WrappedAsyncTaskLoader
import com.helpofai.hoa.musicplayer.model.Song
import com.helpofai.hoa.musicplayer.providers.BlacklistStore
import com.helpofai.hoa.musicplayer.util.FileUtil
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.startDirectory
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.lastDirectory
import com.helpofai.hoa.musicplayer.util.PreferenceUtil.saveLastDirectory
import com.helpofai.hoa.musicplayer.util.ThemedFastScroller.create
import com.helpofai.hoa.musicplayer.util.getExternalStorageDirectory
import com.helpofai.hoa.musicplayer.util.getExternalStoragePublicDirectory
import com.helpofai.hoa.musicplayer.views.BreadCrumbLayout
import com.helpofai.hoa.musicplayer.views.BreadCrumbLayout.Crumb
import com.helpofai.hoa.musicplayer.views.BreadCrumbLayout.SelectionCallback
