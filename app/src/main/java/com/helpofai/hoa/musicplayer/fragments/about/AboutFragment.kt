 ...
 *
 */
package com.helpofai.hoa.musicplayer.fragments.about
...
import com.helpofai.hoa.musicplayer.adapter.ContributorAdapter
import com.helpofai.hoa.musicplayer.databinding.FragmentAboutBinding
...
class AboutFragment : Fragment(R.layout.fragment_about), View.OnClickListener {
    ...
    private fun setUpView() {
        ...
        binding.aboutContent.cardOther.privacyPolicy.setOnClickListener(this)
    ...
    override fun onClick(view: View) {
        when (view.id) {
            ...
            R.id.privacyPolicy -> NavigationUtil.goToPrivacyPolicy(requireActivity())
