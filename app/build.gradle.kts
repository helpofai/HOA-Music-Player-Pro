...
android {
    ...
    defaultConfig {
        ...
        val playLicenseKey = getProperties("local.properties")?.getProperty("GOOGLE_PLAY_LICENSE_KEY") 
            ?: System.getenv("GOOGLE_PLAY_LICENSE_KEY") ?: ""
        buildConfigField("String", "GOOGLE_PLAY_LICENSING_KEY", "\"$playLicenseKey\"")

        // AdMob IDs from local.properties or Env
        val appId = localProperties?.getProperty("ADMOB_APP_ID") 
            ?: System.getenv("ADMOB_APP_ID") 
            ?: "ca-app-pub-3940256099942544~3347511713" // Fallback to Test App ID to prevent crash
